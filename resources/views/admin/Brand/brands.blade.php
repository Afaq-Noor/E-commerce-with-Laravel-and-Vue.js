                                ...
                                @foreach ($data as $list)
                                    <tr>
                                        ...
                                        <td> <button type="button"
                                                ...
                                                <button onclick="deleteData('{{ addslashes($list->id) }}' , 'brands')" class="btn btn-outline-danger px-5 radius-30">Delete</button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="formSubmit" action="{{ url('admin/update-or-add-brands') }}" method="POST"
