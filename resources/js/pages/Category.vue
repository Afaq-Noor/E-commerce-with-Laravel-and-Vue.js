...
<Layout>
    <template v-slot:content>
        ...
        <main>
            ...
            <!-- breadcrumb-area -->
            <section class="breadcrumb-area breadcrumb-bg" data-background="/front_end/img/bg/breadcrumb_bg01.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="sidebar-product-thumb">
                                                    <a href="#"><img src="/front_end/img/product/sidebar_product01.jpg" alt=""></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="sidebar-product-thumb">
                                                    <a href="#"><img src="/front_end/img/product/sidebar_product02.jpg" alt=""></a>
                                                </div>
                                                <div class="sidebar-product-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
                                            ...
                                            <li>
                                                <div class="sidebar-product-thumb">
                                                    <a href="#"><img src="/front_end/img/product/sidebar_product03.jpg" alt=""></a>
                                                </div>
                                                <div class="sidebar-product-content">
                                                    <div class="rating">
                                                        <i class="fas fa-star"></i>
